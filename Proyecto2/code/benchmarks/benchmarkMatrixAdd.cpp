...
BOOST_AUTO_TEST_CASE( Sub ) {
...

    {
      ...
      ::anpi::benchmark::plotRange(times, "On-copy (double) fallback", "g");
    }

    {
      ...
      ::anpi::benchmark::write("sub_on_copy_float_fb.txt", times);
      ::anpi::benchmark::plotRange(times, "On-copy (float) SIMD", "b");
    }

    {
      ...
      ::anpi::benchmark::write("sub_on_copy_double_fb.txt", times);
      ::anpi::benchmark::plotRange(times, "On-copy (double) SIMD", "m");
    }
